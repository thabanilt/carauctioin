        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading panel-main-menus">
                    ...
                    <li {!! (Route::currentRouteName()=='adminHome')?'class="active"':'' !!}><a href="{{route('adminHome')}}">Sell a product</a></li>
                  <li  {!! (Route::currentRouteName()=='sold' || Route::currentRouteName()=='soldDetails')?'class="active"':'' !!}><a href="{{route('sold')}}">Your auctions</a></li>
